---
name: goal-analyzer
description: Analyze personal health goal data — identify goal patterns, evaluate progress, and give personalized goal-management recommendations, correlating goals with nutrition, exercise, and sleep data. Use when the user asks to review or track health/fitness/wellness goals, analyze goal progress, or wants insights connecting their goals to health metrics.
