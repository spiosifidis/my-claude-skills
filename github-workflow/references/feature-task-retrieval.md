...
2. **Find Skill**: Search the installed skills for one matching the task source, or search the marketplace with `npx skills find <keyword>` (e.g., `npx skills find clickup`).
